...
var mainApplicationModule = angular.module(mainApplicationModuleName,['ngResource','ngRoute','mean.controllers','mean.services','mean.routes','tm.pagination']); //创建主模块应用，添加模块依赖
