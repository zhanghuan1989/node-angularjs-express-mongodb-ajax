    ...
    return {
        ...
        link: function(scope, element, attrs){
            ...
            function getPagination(){
                // conf.currentPage
                scope.conf.currentPage = parseInt(scope.conf.currentPage) ? parseInt(scope.conf.currentPage) : 1; //当前页
                // conf.totalItems
                scope.conf.totalItems = parseInt(scope.conf.totalItems); //总条数
                ...
                if(scope.conf.rememberPerPage){
                    ...
                    scope.conf.itemsPerPage = parseInt(localStorage[scope.conf.rememberPerPage]); //每页条数
