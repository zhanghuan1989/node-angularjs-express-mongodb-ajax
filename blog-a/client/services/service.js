...
.factory('listAngularService',['$http',function($http){
    var listAngularService = {};
    listAngularService.getAllUsersList = function(url,postData,callback) {
